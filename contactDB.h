...
public:
    ...
    void addEntry(string first,string last,string phone, string email, string age, string type);
    void editEntry(string idnum,string first,string last,string phone, string email, string age, string type);
